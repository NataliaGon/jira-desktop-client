...
interface DrTProperties extends ComponentBaseProperties {
  DragCard?: any,
  issue?: any,
  id?: any
}
interface DrTState extends ComponentBaseState {
//   pin?:boolean ?
}

 class DrT extends ComponentBase<DrTProperties, DrTState>{
  state = {
    //  pin:false?
  }
